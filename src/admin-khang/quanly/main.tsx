    ...
    return (
        ...
        <div className="box">
            ...
            <div className="statistics">
                <div className="statistics-box" style={{backgroundColor : "#FFE2E5"}}>
                    <img src="/src/assets/icons/h9.png" alt="" />
                    <p>100,000,000 VND</p>
                    <h2>Tổng Doanh Thu</h2>
                </div>
                <div className="statistics-box" style={{backgroundColor : "#FFF4DE"}}>
                    <img src="/src/assets/icons/h10.png" alt="" />
                    <p>200</p>
                    <h2>Tổng Đơn Hàng</h2>
                </div>
                <div className="statistics-box" style={{backgroundColor : "#DCFCE7"}}>
                    <img src="/src/assets/icons/h11.png" alt="" />
                    <p>500</p>
                    <h2>Sản Phẩm Bán</h2>
                </div>
                <div className="statistics-box" style={{backgroundColor : "#F3E8FF"}}>
