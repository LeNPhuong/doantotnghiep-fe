  ...
  return (
    <div className="flex gap-8 px-[100px] my-4">
      ...
      <div className="w-3/4 space-y-4">
        ...
        {/* row2 */}
        <div className="border-[1px] border-[#dbd9d9] py-2 px-4 rounded-t-xl">
        ...
        <div className="flex-col space-y-4 h-[153px] bg-[#004D40] rounded-lg py-6 px-8 ">
          ...
          <div className="flex justify-between items-center text-white">
            <p className="text-[24px] font-medium">
              Lý do hủy: Không muốn mua nữa
            </p>
            <p className="text-[18px] font-medium">Hủy vào ngày 28/10/2024.</p>
          </div>
        </div>
        {/* row4 */}
        <div className="border-[1px] border-[#dbd9d9] space-y-4 py-6 px-8 rounded-lg">
          {/* 1 */}
